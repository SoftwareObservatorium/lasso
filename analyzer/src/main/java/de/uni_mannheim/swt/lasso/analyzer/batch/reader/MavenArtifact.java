...
public class MavenArtifact {
    ...
    private MavenArtifact testArtifact;
    ...
    public MavenArtifact getTestArtifact() {
        return testArtifact;
    }

    public void setTestArtifact(MavenArtifact testArtifact) {
        this.testArtifact = testArtifact;
    }

    public boolean isTests() {
        if(getBinaryJar() == null) {
            return false;
        }

        return StringUtils.endsWith(getBinaryJar().getName(), "-tests.jar");
    }
}
