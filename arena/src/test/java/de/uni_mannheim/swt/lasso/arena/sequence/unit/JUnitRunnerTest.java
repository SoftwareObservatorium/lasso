...
public class JUnitRunnerTest {
    ...
    @Test
    public void test_execute_failing_assertion() throws IOException {
        ...
        Execute execute = new Execute(mavenRepository) {
            ...
            protected CompilationUnit checkCompileErrors(ClassUnderTest cut, List<SequenceExecutionRecord> records, CompilationUnit unit, String testClassSuffix) throws IOException {
                ...
                unit.setSourceCode(t);
                return super.checkCompileErrors(cut, records, unit, testClassSuffix);
            }
        };
        ...
        assertFalse(FileUtils.readFileToString(testFiles.get(0), StandardCharsets.UTF_8).contains("bc7_044d48bc7e5945fd87ee260bc3260f0e"));
    ...
    private String t = "package org.apache.commons.lang;\n" +
            ...
            "        int int3 = 2;\n" +
            "        int int4 = org.apache.commons.lang.ArrayUtils.lastIndexOf(floatArray1, (float) int2, int3);\n" +
            "        org.junit.Assert.assertTrue(\"'\" + int4 + \"' != '\" + (-1) + \"'\", int4 == 1); // SEEDED BUG\n" +
            "    }\n" +
            "}";
}
