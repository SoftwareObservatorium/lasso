 ...
 */
public class PermutatorAdaptedMethod extends AdaptedMethod {

    private final JavaConverterStrategy javaConverterStrategy;

    public PermutatorAdaptedMethod(MethodSignature specification, ClassUnderTest adaptee, Method method, JavaConverterStrategy javaConverterStrategy) {
