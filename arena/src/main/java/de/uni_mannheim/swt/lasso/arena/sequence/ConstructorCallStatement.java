...
public class ConstructorCallStatement extends CallStatement {
    ...
    public ConstructorCallStatement(MethodSignature methodSignature) {
        super(methodSignature);
    }

    public boolean isResolved() {
        return methodSignature instanceof ReflectionConstructorSignature;
    }

    public Constructor<?> getResolvedConstructor() {
        if(!isResolved()) {
            throw new IllegalArgumentException("Constructor is not resolved");
        }

        return ((ReflectionConstructorSignature)methodSignature).getConstructor();
    }
}
