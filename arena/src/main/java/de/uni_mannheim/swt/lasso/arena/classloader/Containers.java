...
public class Containers extends ClassWorld {
    ...
    public synchronized Container create(ClassUnderTest classUnderTest, ContainerFactory factory) throws IllegalAccessException {
        String containerId = String.format("%s_%s", classUnderTest.getFullId(), classUnderTest.toUri());
        ...
        DependencyResult dependencyResult = classUnderTest.getProject().getDependencyResult();
        //
        ...
        // set CUT
        classRealm.setClassUnderTest(classUnderTest);

        return classRealm;
    }

    public synchronized Container createUnsafe(ClassUnderTest classUnderTest, ContainerFactory factory) throws IllegalAccessException {
        String containerId = String.format("%s_%s", classUnderTest.getFullId(), classUnderTest.toUri());
