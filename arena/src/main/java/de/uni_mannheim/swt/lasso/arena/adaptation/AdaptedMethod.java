...
/**
 * Abstract class of an adapted method.
 *
 * @author Marcus Kessel
 */
public abstract class AdaptedMethod extends AdaptedMember {

    public AdaptedMethod(MethodSignature specification, ClassUnderTest adaptee, Method method) {
