 ...
 */
package de.uni_mannheim.swt.lasso.classloader.resolver;
...
public class MavenDependencyResolver {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(MavenDependencyResolver.class);
    ...
    public MavenDependencyResolver(String repoUrl, String localRepoPath) {
