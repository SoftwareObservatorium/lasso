 ...
 */
public class JDKContainerIntegrationTest {
    ...
    public void test_sample() throws InterruptedException {
        ...
        JDKContainer jdkContainer = new JDKContainer(containerService);
        jdkContainer.setImage("openjdk:8-jdk-alpine");
        ...
        List<String> args = new ArrayList<>(Arrays.asList("javac", "src/main/java/com/mycompany/app/App.java", "-d", "bin/"));

        ContainerState containerState = jdkContainer.run(containerName,
