...
/**
 * Single-objective ranking strategy
 * 
 * @author Marcus Kessel
 *
 */
public class SingleObjectiveRanking extends AbstractSmoopRankingStrategy {

    public static final String ID = "SINGLE_SMOOP";
     ...
     */
    public SingleObjectiveRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().single(criteria, candidateItems,
