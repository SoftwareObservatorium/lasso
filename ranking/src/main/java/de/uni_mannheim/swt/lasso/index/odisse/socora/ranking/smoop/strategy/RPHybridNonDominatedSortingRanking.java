...
/**
 * Hybrid, non-dominated sorting ranking strategy incl. apriori weighted distance
 * reference point subranking.
 * 
 * @author Marcus Kessel
 *
 */
public class RPHybridNonDominatedSortingRanking extends
        AbstractSmoopRankingStrategy {

    public static final String ID = "RP_HDS_SMOOP";
     ...
     */
    public RPHybridNonDominatedSortingRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().rphds(criteria, candidateItems,
