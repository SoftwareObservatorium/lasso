...
/**
 * Weighted-distance based on euclidean distance ranking strategy
 * 
 * @author Marcus Kessel
 *
 */
public class WeightedEuclideanRanking extends AbstractSmoopRankingStrategy {

    public static final String ID = "WEIGHTEDEUCLIDEAN_SMOOP";
     ...
     */
    public WeightedEuclideanRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        // weighted metric
        getSmoopRanking().weightedSum(criteria, candidateItems,
                SmoopRanking.METHOD_WEIGHTED_METRIC,
