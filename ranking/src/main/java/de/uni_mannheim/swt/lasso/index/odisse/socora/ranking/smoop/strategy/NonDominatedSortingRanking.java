...
/**
 * Non-dominated sorting ranking strategy.
 * 
 * @author Marcus Kessel
 *
 */
public class NonDominatedSortingRanking extends AbstractSmoopRankingStrategy {

    public static final String ID = "NDS_SMOOP";
     ...
     */
    public NonDominatedSortingRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().nds(criteria, candidateItems,
