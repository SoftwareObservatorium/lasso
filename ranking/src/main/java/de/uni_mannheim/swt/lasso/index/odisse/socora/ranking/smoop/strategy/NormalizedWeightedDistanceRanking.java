...
/**
 * Normalized, weighted distance ranking strategy
 * 
 * @author Marcus Kessel
 *
 */
public class NormalizedWeightedDistanceRanking extends
        AbstractSmoopRankingStrategy {

    public static final String ID = "NORM_WEIGHT_DISTANCE_SMOOP";
     ...
     */
    public NormalizedWeightedDistanceRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().normWeightDistance(criteria, candidateItems,
