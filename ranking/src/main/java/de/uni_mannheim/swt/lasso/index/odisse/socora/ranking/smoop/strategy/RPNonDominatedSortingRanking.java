...
/**
 * Non-dominated sorting ranking strategy incl. apriori weighted distance
 * reference point subranking.
 * 
 * @author Marcus Kessel
 *
 */
public class RPNonDominatedSortingRanking extends AbstractSmoopRankingStrategy {

    public static final String ID = "RP_NDS_SMOOP";
     ...
     */
    public RPNonDominatedSortingRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().rpnds(criteria, candidateItems,
