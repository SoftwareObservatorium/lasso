...
/**
 * Hybrid, non-dominated sorting ranking strategy incl. posteriori preference-based ranking.
 * 
 * @author Marcus Kessel
 *
 */
public class HybridNonDominatedSortingRanking extends
        AbstractSmoopRankingStrategy {

    public static final String ID = "HDS_SMOOP";
     ...
     */
    public HybridNonDominatedSortingRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
            ...
            throws IOException {
        //
        getSmoopRanking().hds(criteria, candidateItems,
