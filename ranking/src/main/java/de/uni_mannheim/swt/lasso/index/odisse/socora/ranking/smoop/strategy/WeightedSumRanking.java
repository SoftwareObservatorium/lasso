...
/**
 * Weighted-sum ranking strategy
 * 
 * @author Marcus Kessel
 *
 */
public class WeightedSumRanking extends AbstractSmoopRankingStrategy {

    public static final String ID = "WEIGHTEDSUM_SMOOP";
     ...
     */
    public WeightedSumRanking(SmoopRanking smoopRanking) {
        super(smoopRanking);
    }
    ...
    protected CandidateItemJs[] doRank(Criterion[] criteria,
        ...
        getSmoopRanking().weightedSum(criteria, candidateItems,
                SmoopRanking.METHOD_WEIGHTED_SUM, rankingPerformanceCollector);
