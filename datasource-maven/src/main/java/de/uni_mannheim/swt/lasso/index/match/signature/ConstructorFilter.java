...
/**
 * Filters out constructors <init>
 *
 * @author Marcus Kessel
 */
public class ConstructorFilter implements SignatureMatchFilter {
    ...
    public boolean accept(SignatureMatch signatureMatch, boolean constructor) {
        ...
        // no name set?
        if(!signatureMatch.hasName()) {
            return true;
        }

        return !signatureMatch.isConstructor();
    }
}
