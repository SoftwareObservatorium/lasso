 ...
 */
public class LQL2LuceneClassQuery implements LQLLuceneStrategy {

    private static final Logger LOG = LoggerFactory.getLogger(LQL2LuceneClassQuery.class);
    ...
    public LQL2LuceneClassQuery(SearchOptions searchOptions) {
