 ...
 */
public class StrictReturnTypeFilter implements SignatureMatchFilter {

    @Override
    public boolean accept(SignatureMatch signatureMatch, boolean constructor) {
        //
        if(signatureMatch.hasReturnTypeMatch()) {
            return true;
        }

        // java.lang.Object?
        return StringUtils.equalsIgnoreCase(signatureMatch.getReturnType(), "java.lang.Object");

        // TODO any assignable type
    }
}
