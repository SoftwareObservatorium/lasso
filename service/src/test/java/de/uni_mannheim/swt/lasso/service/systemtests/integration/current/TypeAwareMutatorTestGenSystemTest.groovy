...
/**
 * Demonstrates TypeAwareMutatorTestGen action.
 *
 * @author mkessel
 */
class TypeAwareMutatorTestGenSystemTest extends AbstractGroovySystemTest {
...
study(name: 'TypeAwareMutatorTestGen-Tests') {
    action(name: 'select') {
    ...
    action(name: 'typeAware', type: 'TypeAwareMutatorTestGen') {
        ...
        // check DFS
        List<String> sequences = DistributedFileSystemUtils.listSequences(lslExecutionContext, "typeAware", "HumanEval_13_greatest_common_divisor")
        println(sequences)
