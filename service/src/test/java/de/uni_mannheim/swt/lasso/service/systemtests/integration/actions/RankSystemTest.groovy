...
/**
 * Demonstrates Rank action (SOCORA)
 *
 * @author mkessel
 */
class RankSystemTest extends AbstractGroovySystemTest {
    ...
    /**
     * Ranking using SOCORA based on a LassoReport (here IndexMeasurements)
     *
     * @throws IOException
     * @throws DataSourceNotFoundException
     */
    @Test
    void test_rank_index_metrics() throws IOException, DataSourceNotFoundException {
        @Language("Groovy")
        String content = '''
        ...
        study(name: 'Select') {
            ...
            action(name:'rank', type:'Rank') {
                ...
                criteria = ['IndexMeasurements.m_static_loc_td:MIN:1', // any report would do
                            'IndexMeasurements.m_static_complexity_td:MIN:2']
        ...
        verifyAbstraction(lslExecutionContext, 'rank', 'Stack', 10)
    }
}
