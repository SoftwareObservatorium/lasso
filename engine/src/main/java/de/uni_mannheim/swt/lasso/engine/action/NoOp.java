...
/**
 * A LASSO action which does nothing (actually it is used for "plain" actions in LSL).
 *
 * @author Marcus Kessel
 */
@LassoAction(desc = "An action which does nothing (actually it is used for plain actions in LSL)")
@Stable
@Local
@DisablePartitioning // redundant
@Tester
public class NoOp extends DefaultAction {

    private static final Logger LOG = LoggerFactory
            .getLogger(NoOp.class);
