 ...
 *
 */
public abstract class LassoConfiguration {

    public abstract DataSource getDataSource(String id);

    public abstract ExecutableCorpus getExecutableCorpus();

    public abstract <T> T getProperty(String name, Class<T> tClass);
