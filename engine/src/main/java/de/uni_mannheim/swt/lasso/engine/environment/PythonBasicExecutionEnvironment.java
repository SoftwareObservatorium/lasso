...
import de.uni_mannheim.swt.lasso.sandbox.container.support.PythonContainer;
 ...
 *
 */
public class PythonBasicExecutionEnvironment extends DockerExecutionEnvironment {

    private static final Logger LOG = LoggerFactory
            .getLogger(PythonBasicExecutionEnvironment.class);

    public PythonBasicExecutionEnvironment(String id, String proxyRegistry, int pullTimeout) {
        super(id, proxyRegistry, pullTimeout);
    }

    @Override
    public ContainerState runContainer() {
        PythonContainer basicContainer = new PythonContainer(getContainerService());
