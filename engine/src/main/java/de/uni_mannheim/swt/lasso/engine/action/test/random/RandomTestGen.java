 ...
 */
package de.uni_mannheim.swt.lasso.engine.action.test.random;
...
/**
 * Random test input generation. See {@link RandomObjectGenerator}.
 *
...
public class RandomTestGen extends DefaultAction {
    ...
    public void execute(LSLExecutionContext context, ActionConfiguration actionConfiguration) throws IOException {
        ...
        List<Sheet> stimulusSheets = SequenceUtils.sequences2SheetsJSONL(sequences, abstraction.getSpecification(), true, "random");
        // set to FA
        abstraction.getSpecification().getTests().addAll(stimulusSheets);
