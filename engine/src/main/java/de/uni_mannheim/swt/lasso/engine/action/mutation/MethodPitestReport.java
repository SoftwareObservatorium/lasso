 ...
 */
public class MethodPitestReport extends LassoReport {
    ...
    private MultiValuedMap<String, String> killers;
    ...
    public MultiValuedMap<String, String> getKillers() {
        return killers;
    }

    public void setKillers(MultiValuedMap<String, String> killers) {
